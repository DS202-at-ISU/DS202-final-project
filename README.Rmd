...
# Final Project - Team XXX {.unnumbered}
...
In your write-up, make sure to refer to the figure. You can include a hyperlink to Figure \@ref(fig:code-chunk-name) using the name of the code chunk (make sure, to give each code chunk a different name) by using `\@ref(fig:code-chunk-name)` in your write-up.
